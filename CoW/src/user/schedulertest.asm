...
int main()
{
  ...
  42:	84250513          	addi	a0,a0,-1982 # 880 <malloc+0xf2>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 444:	4c050513          	addi	a0,a0,1216 # 900 <digits>
 448:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 504:	3a8c8c93          	addi	s9,s9,936 # 8a8 <malloc+0x11a>
 ...
 512:	3f2b8b93          	addi	s7,s7,1010 # 900 <digits>
 ...
 638:	26c98993          	addi	s3,s3,620 # 8a0 <malloc+0x112>
        while(*s != 0){
 63c:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 868:	b78080e7          	jalr	-1160(ra) # 3dc <sbrk>
  if(p == (char*)-1)
