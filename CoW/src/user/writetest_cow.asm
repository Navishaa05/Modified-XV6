...
user/_writetest_cow:     file format elf64-littleriscv
...
int main()
{
  ...
  10:	386080e7          	jalr	902(ra) # 392 <sbrk>
  14:	84aa                	mv	s1,a0
  ...
  1e:	2e8080e7          	jalr	744(ra) # 302 <fork>

    if (pid < 0)
  22:	02054263          	bltz	a0,46 <main+0x46>
    {
        printf("Fork failed\n");
        exit(0);
    }
  ...
  42:	2cc080e7          	jalr	716(ra) # 30a <exit>
        printf("Fork failed\n");
  46:	00000517          	auipc	a0,0x0
  4a:	7ea50513          	addi	a0,a0,2026 # 830 <malloc+0xec>
  4e:	00000097          	auipc	ra,0x0
  52:	63e080e7          	jalr	1598(ra) # 68c <printf>
        exit(0);
  56:	4501                	li	a0,0
  58:	00000097          	auipc	ra,0x0
  5c:	2b2080e7          	jalr	690(ra) # 30a <exit>
    }
    else
    {
  ...
  66:	2b0080e7          	jalr	688(ra) # 312 <wait>
        printf("Parent: Write test complete.\n");
  6a:	00000517          	auipc	a0,0x0
  6e:	7fe50513          	addi	a0,a0,2046 # 868 <malloc+0x124>
  72:	00000097          	auipc	ra,0x0
  76:	61a080e7          	jalr	1562(ra) # 68c <printf>
    }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	4f250513          	addi	a0,a0,1266 # 8e8 <digits>
 3fe:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ba:	3dac8c93          	addi	s9,s9,986 # 890 <malloc+0x14c>
 ...
 4c8:	424b8b93          	addi	s7,s7,1060 # 8e8 <digits>
 ...
 5ee:	29e98993          	addi	s3,s3,670 # 888 <malloc+0x144>
        while(*s != 0){
 5f2:	85ee                	mv	a1,s11
